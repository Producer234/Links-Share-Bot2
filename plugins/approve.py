# +++ Modified By Yato [telegram username: @main_channel_pr & @owner_of_pr] +++ # aNDI BANDI SANDI JISNE BHI CREDIT HATAYA USKI BANDI RAndi 
import os
import asyncio
from config import *
...
async def autoapprove(client, message: ChatJoinRequest):
    ...
    if APPROVED == "on":
        ...
        buttons = [
         [InlineKeyboardButton('• ᴊᴏɪɴ ᴍʏ ᴜᴘᴅᴀᴛᴇs •', url='https://t.me/ALL_PR_BOTS')],
          [InlineKeyboardButton('• ᴊᴏɪɴ ᴍʏ ᴍᴀɪɴ ᴄʜᴀɴɴᴇʟ •', url='https://t.me/PR_X_MAIN_CHANNEL')],
        ...
        await client.send_photo(
            chat_id=user.id,
            photo='https://res.cloudinary.com/dqs0i4x9y/image/upload/v1756229930/rnlz6y6n5g4k7answrl9.jpg',
            caption=caption,
            reply_markup=markup
        )
